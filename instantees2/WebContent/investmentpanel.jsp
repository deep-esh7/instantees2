                ...
                <h5>Enter data acording to category id</h5>
                        <form class="form-signin">
                          <div class="form-label-group">
                            <input type="name" id="inputName" class="form-control" name="namefclient"  required autofocus>
...
<div class="container">
  <div class="jumbotron" style="color:green">
    <h4>PLEASE ENTER DATA ACCORDING TO CATEGORY ID:</h4>
        ...
        <div class="container">
  <ul class="list-group">
    <li class="list-group-item list-group-item-success">29:INSURACE</li>
    <li class="list-group-item list-group-item-success">30:TAXATION</li>
    <li class="list-group-item list-group-item-success">31:WORKERS</li>
    <li class="list-group-item list-group-item-success">32:CONSULTATION</li>
    <li class="list-group-item list-group-item-success">33:LOANS</li>
    <li class="list-group-item list-group-item-success">34:TRAVELS</li>
    <li class="list-group-item list-group-item-success">35:PARTY PLANNERS</li>
