  ...
  <div class="profile-page">
    <div class="wrapper">
      <div class="page-header page-header-small" filter-color="white">
        <div class="page-header-image" data-parallax="true" style="background-image: url('./images/investment.jpg');"></div>
        <div class="container">
          <div class="content-center">
            ...
            <p class="category text-white">INVEST WITH US!</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Discover</a></a>
          </div>
        </div>
        <div class="section">
          <div class="container">
