    ...
    <div class="container">
      <div class="jumbotron" style="color:green">
        <h4>PLEASE ENTER DATA ACCORDING TO CATEGORY ID:</h4>
            ...
            <div class="container">
      <ul class="list-group">
        <li class="list-group-item list-group-item-success">36:CIVIL LAWYER</li>
        <li class="list-group-item list-group-item-success">37:COPERATE</li>
        <li class="list-group-item list-group-item-success">38:CRIMINAL</li>
        <li class="list-group-item list-group-item-success">39:CONSULTATION</li>
        <li class="list-group-item list-group-item-success">40:LIFE INSURANCE</li>
        <li class="list-group-item list-group-item-success">41:BUSSINESS</li>
        <li class="list-group-item list-group-item-success">42:GOLD</li>
        <li class="list-group-item list-group-item-success">43:TRAVEL </li>
        <li class="list-group-item list-group-item-success">44:PROJECT MANAGEMENT</li>
        <li class="list-group-item list-group-item-success">45:ADVERTISEMENT</li>
      </ul>
     </div> 
