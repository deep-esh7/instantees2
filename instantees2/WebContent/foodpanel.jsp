    ...
    <div class="container">
      <div class="jumbotron" style="color:green">
        <h4>PLEASE ENTER DATA ACCORDING TO CATEGORY ID:</h4>
            ...
            <div class="container">
      <ul class="list-group">
        <li class="list-group-item list-group-item-success">21:NON-VEG</li>
        <li class="list-group-item list-group-item-success">22:VEG</li>
        <li class="list-group-item list-group-item-success">23:STARTER</li>
        <li class="list-group-item list-group-item-success">24:DRINKS</li>
        <li class="list-group-item list-group-item-success">25:CAKE </li>
        <li class="list-group-item list-group-item-success">26:BREADS</li>
        <li class="list-group-item list-group-item-success">27:FRUITS</li>
        <li class="list-group-item list-group-item-success">28:CHINEESE </li>
      </ul>
     </div> 
